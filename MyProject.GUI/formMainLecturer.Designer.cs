...
namespace MyProject.GUI
{
    partial class formMainLecturer
    {
        ...
        private void InitializeComponent()
        {
            ...
            TreeNode treeNode22 = new TreeNode("Trang chủ");
            TreeNode treeNode23 = new TreeNode("Lịch giảng dạy");
            TreeNode treeNode24 = new TreeNode("Cập nhật điểm");
            TreeNode treeNode25 = new TreeNode("Thông tin phần mềm");
            TreeNode treeNode26 = new TreeNode("Thay đổi thông tin");
            TreeNode treeNode27 = new TreeNode("Đăng xuất");
            TreeNode treeNode28 = new TreeNode("Tài khoản", new TreeNode[] { treeNode26, treeNode27 });
            ...
            lblUser.Location = new Point(19, 16);
            lblUser.Name = "lblUser";
            lblUser.Padding = new Padding(0, 2, 0, 0);
            lblUser.Size = new Size(141, 25);
            lblUser.TabIndex = 1;
            lblUser.Text = "User: Giảng viên";
            // 
            // pnlLeft
            // 
            ...
            treeNode22.Name = "";
            treeNode22.Text = "Trang chủ";
            treeNode23.Name = "";
            treeNode23.Text = "Lịch giảng dạy";
            treeNode24.Name = "";
            treeNode24.Text = "Cập nhật điểm";
            treeNode25.Name = "";
            treeNode25.Text = "Thông tin phần mềm";
            treeNode26.Name = "";
            treeNode26.Text = "Thay đổi thông tin";
            treeNode27.Name = "";
            treeNode27.Text = "Đăng xuất";
            treeNode28.Name = "";
            treeNode28.Text = "Tài khoản";
            uiNavMenu.Nodes.AddRange(new TreeNode[] { treeNode22, treeNode23, treeNode24, treeNode25, treeNode28 });
